...
const CarSpecifications = ({ car }) => {
  return (
    <>
      <div className="w-[312px] h-[58px] text-black text-[26px] font-bold font-['Plus Jakarta Sans'] leading-[35px]">
        Specification
      </div>
            ...
            {car.specifications.map((specs, index) => (
              ...
              >
                {specs.map((spec, i) => (
                  <div
                    key={i}
                    className="w-[151px] h-[19px] text-black text-base font-normal font-['Plus Jakarta Sans']"
                  >
                    {spec}
                  </div>
                ))}
