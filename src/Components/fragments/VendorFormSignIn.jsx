...
const VendorFormSignIn = () => {
  ...
  return (
    <div
      className="inline-flex items-center justify-start mx-20 mb-20 pl-10  gap-5 bg-white border border-gray-200 rounded-lg w-[1320px] h-[640px]
    ...
    >
      ...
      <Fade direction="right" duration={2000}>
        <div className="flex flex-col w-[408px] h-[535px]">
          <h1 className="flex items-start justify-center text-center text-5xl text-black pb-10 pl-10">
            <span className="font-Playball italic ">Vendor </span>
          ...
          <form className="max-w-sm mx-20" onSubmit={SignIn}>
            ...
            <h5 className="text-sm flex items-center justify-start mt-1 text-gray-500">
              ...
              <button className="font-sm text-red-600">
                {" "}
                <Link to="/VendorSignUp"> Sign Up here</Link>{" "}
              </button>
            </h5>
          </form>
        </div>
