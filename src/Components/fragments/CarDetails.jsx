        ...
        <div className="w-[697px] px-10 py-[35px] bg-white rounded-[25px] border border-zinc-400 justify-start items-start gap-[55px]">
            ...
            <div className="justify-center items-center gap-[65px] flex">
                <div className="px-4 py-3 justify-start items-center gap-2.5 flex">
                    <img className="w-[146px] h-[66px] mr-10 pl-1" src="/Logo.png" alt="Dummy Logo" />
                ...
                <div className="justify-start items-start gap-4 flex">
                    {car.features.map((feature, index) => (
                        <div key={index} className="p-2.5 rounded-[13px] border border-sky-950 justify-center items-center gap-2.5 flex">
                            <div className="text-black text-xl font-light font-['Plus Jakarta Sans']">{feature}</div>
                        </div>
                    ))}
                </div>
            </div>
